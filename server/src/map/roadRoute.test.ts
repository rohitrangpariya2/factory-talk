...
describe('road route proxy helpers', () => {
  ...
  test('builds a fixed OSRM route URL over HTTPS', () => {
    ...
    expect(url).toBe(
      'https://router.project-osrm.org/route/v1/driving/72.938619,21.259844;72.875577,21.218610?overview=full&geometries=geojson&steps=false&annotations=false&radiuses=10%3B10'
    );
  });
});
